...
var AnimatedHeader = function () {
    function AnimatedHeader(opts) {
        classCallCheck(this, AnimatedHeader);

        // Provide defaults for passed options
        var _ref = opts ? opts : {},
            _ref$elementSelector = _ref.elementSelector,
            elementSelector = _ref$elementSelector === undefined ? '.app__header' : _ref$elementSelector,
            _ref$scrollSelector = _ref.scrollSelector,
            scrollSelector = _ref$scrollSelector === undefined ? window : _ref$scrollSelector,
            _ref$openClass = _ref.openClass,
            openClass = _ref$openClass === undefined ? 'open' : _ref$openClass,
            _ref$closeClass = _ref.closeClass,
            closeClass = _ref$closeClass === undefined ? 'close' : _ref$closeClass,
            _ref$inSpeed = _ref.inSpeed,
            inSpeed = _ref$inSpeed === undefined ? 600 : _ref$inSpeed,
            _ref$outSpeed = _ref.outSpeed,
            outSpeed = _ref$outSpeed === undefined ? 600 : _ref$outSpeed;

        // Bind our options to the object


        this.$element = jquery(elementSelector);
        this.scrollContainer = jquery(scrollSelector)[0];
    ...
    createClass(AnimatedHeader, [{
        ...
        value: function show() {
            ...
            animateElement(this.$element, this.openClass, 0, this.inSpeed, false, function () {
        ...
        value: function hide() {
            ...
            animateElement(this.$element, this.closeClass, 0, this.outSpeed, true, function () {
                _this2.state.busy = false;
            });
        }
    }, {
        key: 'onPin',
        ...
        value: function init() {
            ...
            var options = {
                ...
                onUnpin: function onUnpin() {
                    return _this3.onUnpin();
                },
                onTop: function onTop() {
                    return _this3.onTop();
                },
                onNotTop: function onNotTop() {
                    return _this3.onNotTop();
                },
                onBottom: function onBottom() {
                    return _this3.onBottom();
                },
                onNotBottom: function onNotBottom() {
                    return _this3.onNotBottom();
                }
            };
            ...
            var headroom$$1 = new headroom(elem, options);
            headroom$$1.init();
        }
    }]);
...
var MobileNavigation = function () {
    function MobileNavigation(opts) {
        ...
        var _ref = opts ? opts : {},
            ...
            target = _ref$target === undefined ? '#js-mobile-menu--target' : _ref$target,
            _ref$openClass = _ref.openClass,
            openClass = _ref$openClass === undefined ? 'open' : _ref$openClass,
            _ref$closeClass = _ref.closeClass,
            closeClass = _ref$closeClass === undefined ? 'close' : _ref$closeClass,
        ...
        this.$anchor = jquery('a[href*="' + target + '"]');
        this.openClass = openClass;
        this.closeClass = closeClass;
        this.inSpeed = inSpeed;
        this.outSpeed = outSpeed;
    ...
    createClass(MobileNavigation, [{
        ...
        value: function openMenu() {
            ...
            // Animate element
            animateElement(this.$target, this.openClass, 0, this.inSpeed, false, function () {
        ...
        value: function closeMenu() {
            ...
            this.state.busy = true;
            // Animate element
            animateElement(this.$target, this.closeClass, 0, this.outSpeed, true, function () {
...
function positionSticky($elems, $context, responseTime) {
    ...
    var $stickyItems = $elems,
        $scrollContainer = $context ? $context : jquery(window),
        // traditionally; $( window )
    ...
    function checkStuck($item) {
        ...
        var itemPos = $item.offset().top - $context.offset().top;
        ...
        function onScroll() {
            ...
            scrollTimer = setTimeout(function () {
                requestAnimationFrame(function () {
                    return checkStuck($item);
                });
            }, response);
        }

        $scrollContainer.on('load', function () {
...
var fastclick$1 = createCommonjsModule(function (module) {
	(function () {
		'use strict';
...
*/
var appNav = new MobileNavigation({
  target: '#app__nav',
  inSpeed: 900,
  outSpeed: 900
});

var appHeader = new AnimatedHeader({
...
positionSticky(jquery('.cards--sticky .cards__title'), jquery('.app__page > .content'), 55);
...
var fastclick = new fastclick$1(document.body);
